...
const SlideToggle = ({
  ...
  const [expanded, setexpanded] = useState(props.expanded ? props.expanded : defaults.expanded);
  ...
  const handleAnimation = useCallback(time => {
...
export { SlideToggle };
//# sourceMappingURL=react-smooth-slide-toggle.esm.js.map
